...
export default function Home({ rafterPosts, barkpassPosts, posts }) {
  return (
    <div className="mt-8">
      <NextSeo
        title="Ivan - Blog"
      ...
      <div className="max-w-3xl mx-auto mb-6 p-4">
        <div className="mb-12">
          <h1 className="text-4xl font-black mb-4">🤙🏻 Hello, im Ivan</h1>
        ...
        <div className="mb-8 md:mb-0 md:w-1/2 md:px-4">
          ...
          <span className="inline-flex rounded-md shadow-sm">
            <span className="inline-flex rounded-md shadow-sm">
              <a
                href={buttonUrl}
                className="inline-flex items-center px-4 py-2 border border-gray-300 text-base leading-6 font-medium rounded-md text-gray-700 bg-white hover:text-gray-500 focus:outline-none focus:border-orange-300 focus:shadow-outline-orange active:text-gray-800 active:bg-gray-50 transition ease-in-out duration-150"
              >
                {buttonText}
              </a>
            </span>
